...
public class SampleService {
    ...
    public boolean sample(@PathParam("id") int id, @ApiParam(value = "Frequency sampling between 1:100") @QueryParam("frequency") int frequency, @ApiParam(value = "Sample time in seconds") @QueryParam("seconds") int seconds) throws BoardNotFoundException, DatabaseConnectionError {
        try {
            ...
            Command stop = new Sample(board, frequency, seconds);
            return stop.execute();
